...
var m=a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(m).attr({id:"gbox_"+this.id,dir:i}).insertBefore(j);a(j).attr("id","gview_"+this.id).appendTo(m);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+"'></div>").insertBefore(j);a("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'><div class='loading-bar'></div><div class='loading-bar'></div><div class='loading-bar'></div><div class='loading-bar'></div><div class='loading-text'>"+this.p.loadtext+"</div></div>").insertBefore(j);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,
...
i=g.frozen?a("tr#"+d+" td:eq("+a.jgrid.getCellIndex(this)+") > div",f):a(this).parent(),j={keys:!1,onEdit:null,onSuccess:null,afterSave:null,onError:null,afterRestore:null,extraparam:{},url:null,restoreAfterError:!0,mtype:"POST",delOptions:{},editOptions:{}},k=function(d){a.isFunction(j.afterRestore)&&j.afterRestore.call(b,d);i.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").show();i.find("div.ui-inline-save,div.ui-inline-cancel,a.ui-inline-save,a.ui-inline-cancel").hide()};void 0!==g.formatoptions&&(j=a.extend(j,g.formatoptions));void 0!==
h.editOptions&&(j.editOptions=h.editOptions);void 0!==h.delOptions&&(j.delOptions=h.delOptions);e.hasClass("jqgrid-new-row")&&(j.extraparam[h.prmNames.oper]=h.prmNames.addoper);e={keys:j.keys,oneditfunc:j.onEdit,successfunc:j.onSuccess,url:j.url,extraparam:j.extraparam,aftersavefunc:function(d,c){a.isFunction(j.afterSave)&&j.afterSave.call(b,d,c);i.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").show();i.find("div.ui-inline-save,div.ui-inline-cancel,a.ui-inline-save,a.ui-inline-cancel").hide()},errorfunc:j.onError,afterrestorefunc:k,restoreAfterError:j.restoreAfterError,
mtype:j.mtype};switch(c){case "edit":f.jqGrid("editRow",d,e);f.find("a.ui-inline-save,a.ui-inline-cancel").hide();f.find("a.ui-inline-edit").show();i.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").hide();i.find("div.ui-inline-save,div.ui-inline-cancel,a.ui-inline-save,a.ui-inline-cancel").show();f.triggerHandler("jqGridAfterGridComplete");break;case "save":f.jqGrid("saveRow",d,e)&&(i.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").show(),i.find("div.ui-inline-save,div.ui-inline-cancel,a.ui-inline-save,a.ui-inline-cancel").hide(),f.triggerHandler("jqGridAfterGridComplete"));break;case "cancel":f.jqGrid("restoreRow",d,k);i.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").show();
