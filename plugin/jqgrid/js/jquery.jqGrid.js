...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'><div class='loading-bar'><div class='loading-bar'><div class='loading-bar'><div class='loading-bar'><div class='loading-text'>"+this.p.loadtext+"</div></div>").insertBefore(gv);
	...
	$.fn.fmatter.rowactions = function(act) {
		var $tr = $(this).closest("tr.jqgrow"),
			...
			saverow = function(rowid, res) {
				...
				$actionsDiv.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").show();
				$actionsDiv.find("div.ui-inline-save,div.ui-inline-cancel,a.ui-inline-save,a.ui-inline-cancel").hide();
			},
		...
		switch(act)
		{
			case 'edit':
				...
				$grid.find("a.ui-inline-save,a.ui-inline-cancel").hide();
				$grid.find("a.ui-inline-edit").show();
				$actionsDiv.find("div.ui-inline-edit,div.ui-inline-del,a.ui-inline-edit,a.ui-inline-del").hide();
				$actionsDiv.find("div.ui-inline-save,div.ui-inline-cancel,a.ui-inline-save,a.ui-inline-cancel").show();
