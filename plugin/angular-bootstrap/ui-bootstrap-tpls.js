...
angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html","template/accordion/accordion.html","template/alert/alert.html","template/carousel/carousel.html","template/carousel/slide.html","template/datepicker/datepicker.html","template/datepicker/day.html","template/datepicker/month.html","template/datepicker/popup.html","template/datepicker/year.html","template/modal/backdrop.html","template/modal/window.html","template/pagination/pager.html","template/pagination/pagination.html","template/tooltip/tooltip-html-popup.html","template/tooltip/tooltip-html-unsafe-popup.html","template/tooltip/tooltip-popup.html","template/tooltip/tooltip-template-popup.html","template/popover/popover-html.html","template/popover/popover-template.html","template/popover/popover.html","template/progressbar/bar.html","template/progressbar/progress.html","template/progressbar/progressbar.html","template/rating/rating.html","template/tabs/tab.html","template/tabs/tabset.html","template/tabs/crtabset.html","template/timepicker/timepicker.html","template/typeahead/typeahead-match.html","template/typeahead/typeahead-popup.html"]);
...
.service('dateParser', ['$log', '$locale', 'orderByFilter', 'DateService', function($log, $locale, orderByFilter, DateService) {
  ...
  this.parse = function(input, format, baseDate) {
    ...
    if ( results && results.length ) {
      ...
      if ( isValid(fields.year, fields.month, fields.date) ) {
        dt = DateService.getFormattedMomentWithTzFromDateTimeFields(fields.year, fields.month, fields.date, fields.hours, fields.minutes);
      }
...
.controller('TabsetController', ['$scope', function TabsetCtrl($scope) {
  ...
  ctrl.select = function(selectedTab) {
    ...
    if (!selectedTab.initialized) {
      ...
      //Warning: Remove watcher for custom ng-if after initialized gets true
      if (selectedTab.$$watchers.length > 3) {
        selectedTab.$$watchers.splice(3, 1);
      }
    }
  ...
  return {
    ...
    link: function(scope, elm, attrs, tabsetCtrl, transclude) {
      scope.$watch('active', function(active) {
        ...
        // }
		scope.idx = tabsetCtrl.tabs.indexOf(scope);
		var elmPane = angular.element(elm[0]).parent().next().children()[scope.idx]; //li->ul->div(tab-content)->div(tab-pane)
		if (active) {
			tabsetCtrl.select(scope);
...
.directive('tabHeadingTransclude', [function() {
  return {
    ...
    link: function(scope, elm, attrs, tabCtrl) {
      scope.$watch('heading', function updateHeadingElement(heading) {
        if (heading) {
          elm.html('');
          elm.append(heading);
        }
...
angular.module("template/tabs/tab.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tab.html",
    ...
    "  <a href ng-click=\"select()\" id=\"tab{{idx}}\" tab-heading-transclude>{{heading}}</a>\n" +
    "</li>\n" +
    "");
}]);
...
angular.module("template/tabs/crtabset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/crtabset.html",
      "<div>\n" +
      "  <ul class=\"nav nav-{{type || 'tabs'}}\" ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified}\" ng-transclude></ul>\n" +
      "  <div class=\"tab-content\">\n" +
      ...
      "         ng-class=\"{active: tab.active}\"\n" +
      "         ng-if=\"tabs[$index].active || tabs[$index].initialized\" ng-cloak\n" +
      "         tab-content-transclude=\"tab\">\n" +
      "    </div>\n" +
      "  </div>\n" +
      "</div>\n" +
