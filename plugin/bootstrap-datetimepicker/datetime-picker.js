...
angular.module('ui.bootstrap.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .directive('datetimePicker', ['$compile', '$parse', '$document', '$timeout', '$position', 'dateFilter', 'dateParser', 'uiDatetimePickerConfig', '$rootScope', 'DateService',
        function ($compile, $parse, $document, $timeout, $position, dateFilter, dateParser, uiDatetimePickerConfig, $rootScope, DateService) {
            return {
                restrict: 'A',
                require: 'ngModel',
                scope: {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    if (!isHtml5DateInput) {
                        ...
                        ngModel.$formatters.push(function(value) {
                            scope.date = value;
                            return ngModel.$isEmpty(value) ? value : DateService.getFormattedMomentWithTzFromTimestampFull(value);
                        });
                    } else {
