...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function() {
      ...
      escapedSearchText = UpperCaser.toUpper(escapedSearchText);
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.include_option_in_results(option)) {
          ...
          if (!(option.group && !this.group_search)) {
            ...
            var search_text_upper = UpperCaser.toUpper(option.search_text);

            option.search_match = this.search_string_match(search_text_upper, regex);
            ...
            if (option.search_match) {
              if (searchText.length) {
                startpos = search_text_upper.search(zregex);
