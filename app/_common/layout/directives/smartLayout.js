...
// security - authService injection
angular.module('SmartAdmin.Layout').directive('smartLayout', function ($rootScope, $state, $timeout, $interval, $q, SmartCss, authService) {
...
//                    full window height appHeight = Math.max($menu.outerHeight() - 10, getDocHeight() - 10);
            ...
            $rootScope.$on('$stateChangeSuccess', function (event, toState, toParams, fromState, fromParams) {
                ...
                if (authService.getStateReload() === true) {
                    authService.setStateReload(false);
                    ``
                }
            });
